...
proyecto Edad con Salud.
Su objetivo es ayudar a automatizar las tareas de procesamiento de datos del
proyecto.
...
Sin embargo, **esta plantilla no sustituye a ese documento**.
Por favor, lee dicho documento para conocer todas las instrucciones
y convenciones del proceso de generación de variables outcome de Edad con Salud.
...
options(width = 85) # Ancho de salida de texto en R
...
Aquí debes incluir una tabla con los datos principales de todas la/s variable/s finales generada/s. Esto es, el nombre de la/s variable/s (tal y como aparece/n en la base de datos), la/s etiqueta/s, el formato (e.g., categórica, continua) y los valores posibles (e.g., rango para continuas, opciones de respuesta para variables categóricas).
...
+--------------------+--------------------------------+-------------+----------------------+
| bmi_cont_std       | Body mass index (standardized) | Continuous  | standardized         |
+--------------------+--------------------------------+-------------+----------------------+
...
* TODO: Añadir `, replace` al final del comando (si es necesario)

* Cohorte 2011, linea base:
* save "~\UAM\marta.miret@uam.es - Documentacion Edad con Salud\Edad con salud - Ola 1 - Línea base\Outcomes\Outcome datasets\Outcome_<variable>_<qualifier>.dta", replace // TODO: Aviso! El acento en "Línea" puede dar problemas con la ruta del archivo

* Cohorte 2011, ola 2:
* save "~\UAM\marta.miret@uam.es - Documentacion Edad con Salud\Edad con salud - Ola 2\Outcomes\Outcome datasets\Outcome_<variable>_<qualifier>.dta", replace

* Cohorte 2011, ola 3:
* save "~\UAM\marta.miret@uam.es - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2011\Outcome datasets\Outcome_<variable>_<qualifier>.dta", replace
...
* Cohorte 2019, ola post-confinamiento:
* save "~\UAM\marta.miret@uam.es - Documentacion Edad con Salud\Edad con salud - Subestudio COVID\Outcomes\Outcome datasets\Outcome_<variable>_<qualifier>.dta", replace
```
